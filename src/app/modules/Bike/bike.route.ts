...
router.post("/bikes",validateRequest(BikeValidationSchema.createBikeValidation), bikeController.createBikeIntoDb)
router.get("/bikes", bikeController.getAllBikesFromDbWithQuery)
router.get("/bikes/:id", bikeController.getSingleBikeFromDb)
router.put("/bikes/:id", validateRequest(BikeValidationSchema.updateBikeValidation), bikeController.updateBikeIntoDb)
