...
const createServiceRecordIntoDb = catchAsync(async (req, res) => {
    const serviceRecord = await serviceRecordService.createServiceRecordIntoDb(req?.body);
    sendResponse(res, {
...
const getAllServiceRecordsFromDb = catchAsync(async (req, res) => {
    const serviceRecords = await serviceRecordService.getAllServiceRecordsFromDb(req?.query);
    sendResponse(res, {
...
const getSingleServiceRecordFromDb = catchAsync(async (req, res) => {
    const serviceRecord = await serviceRecordService.getSingleServiceRecordFromDb(req?.params?.id);
    sendResponse(res, {
        statusCode: status.OK,
        success: true,
...
const updateServiceRecordIntoDb = catchAsync(async (req, res) => {
    const serviceRecord = await serviceRecordService.updateServiceRecordIntoDb(req?.params?.id, req?.body);
    sendResponse(res, {
        statusCode: status.OK,
        success: true,
...
const getStatusBaseServiceRecordFromDb = catchAsync(async (req, res) => {
    const serviceRecord = await serviceRecordService.getStatusBaseServiceRecordFromDb();
    sendResponse(res, {
        statusCode: status.OK,
        success: true,
