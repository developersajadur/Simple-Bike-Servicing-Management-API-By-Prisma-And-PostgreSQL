...
router.post("/customers", validateRequest(CustomerValidationSchema.createCustomerValidation), customerController.createCustomerIntoDb)
...
router.put("/customers/:id",  validateRequest(CustomerValidationSchema.updateCustomerValidation), customerController.updateCustomerIntoDb)
